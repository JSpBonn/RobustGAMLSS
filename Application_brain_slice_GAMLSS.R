...
# pred_sig2 <- log(1/predict(gam4[stopping],newdata = brain[,1:3],type="response",parameter = "sigma")^0.5) # eta_theta_sigma, robust
...
#### you can also smooth the boundaries of the brain slice to generate a prettier plot (cf. Speller et al.) 
